...
| `love-ref`                | `false`  | `"11.5"`                 | `love-android` git ref. Could be commit hash, tags or branch name                                                                                    |
...
| `version-string`          | `false`  | `""`                     | App version string no more than 3 numbers. Used in `app/build.gradle`                                                                                |
